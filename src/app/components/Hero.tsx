...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center pt-28 pb-28 sm:pt-32 sm:pb-36">
      {/* Animated Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          {/* Right Side - Image */}
          <div className="flex justify-center order-1 lg:order-2 pt-6 sm:pt-0 mt-4">
            <div className="relative mt-4 sm:mt-0">
              ...
              <div className="relative z-10 group">
                <div className="relative w-52 h-52 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border-4 border-background/50 shadow-2xl">
