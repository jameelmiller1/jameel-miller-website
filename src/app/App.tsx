...
export default function App() {
  ...
  // Navigation anchors align with section IDs for smooth in-page jumps.
  const navItems = [
  ...
  return (
    // ThemeProvider controls the system/light/dark UI skin.
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="shrink-0">
                <h3 className="tracking-tight">Full-Stack AI Software Developer</h3>
              </div>
        ...
        <footer className="bg-secondary/10 py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground">
              © 2026 Jameel Miller. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
